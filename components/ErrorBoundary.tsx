...
// FIX: Refactored to use class property syntax for state and arrow functions for handlers.
// This is a more modern and robust pattern for React class components that avoids manual `this` binding.
